...
const projects = [
  {
    ...
    description: 'Plataforma de e-commerce completa com painel admin, carrinho, pagamentos via Stripe e autenticação JWT. Backend em Node.js com PostgreSQL e frontend em React.',
